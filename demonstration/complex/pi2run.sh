...
# Demonstration 1 (simple) - PI #2 has a drone, drone charger, earthquake device, hurricane device and wildfire device (5 devices which 8 sensors/actuators each)
...
python hurricanedevice.py --device-name EarthquakeDevice-1  --device-ip 10.35.70.2 --device-port 33503 --discovery-ip 0.0.0.0 10.35.70.27 10.35.70.25 --discovery-port 33800
